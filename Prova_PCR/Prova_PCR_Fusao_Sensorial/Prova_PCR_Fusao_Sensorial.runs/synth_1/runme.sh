...
HD_PWD='C:/Users/Matheus Moreira/Documents/UnB/PCR/Prova_PCR_Fusao_Sensorial/Prova_PCR_Fusao_Sensorial.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Fusao_sensorial.vds -m64 -mode batch -messageDb vivado.pb -notrace -source Fusao_sensorial.tcl
