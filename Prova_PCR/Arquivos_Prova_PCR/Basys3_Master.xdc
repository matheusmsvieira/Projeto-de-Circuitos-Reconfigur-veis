...
## - rename the used ports (in each line, after get_ports) according to the top level signsegnames in the project
...
#set_property PACKAGE_PIN T18 [get_ports seget]
#set_property IOSTANDARD LVCMOS33 [get_ports reset]
#set_property PACKAGE_PIN W19 [get_ports {PUSH[1]}]
